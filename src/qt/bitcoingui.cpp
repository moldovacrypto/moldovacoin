	...
	stakeForCharityDialog(0)
{
    updateStyle();
    resize(1000, 600);
    setWindowTitle(tr("Moldovacoin") + " - " + tr("Version: 1.0.0.1"));
#ifndef Q_OS_MAC
    ...
    {
        progressBar->setStyleSheet("QProgressBar { background-color: #72adb5; border: 1px solid #97e6e6; border-radius: 7px; padding: 1px; text-align: center; } QProgressBar::chunk { background: #72db5; border-radius: 7px; margin: 0px; }");
    }
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Moldovacoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About Moldovacoin"), this);
    aboutAction->setStatusTip(tr("Show information about Moldovacoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/icons/qt"), tr("About &Qt"), this);
    aboutQtAction->setStatusTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setStatusTip(tr("Modify configuration options for Moldovacoin"));
	...
	resourcesMARAction = new QAction(QIcon(":/icons/web-main"), tr("&Moldovacoin.net"), this);
	resourcesMARAction->setToolTip(tr("Visit the Official Moldovacoin website"));
	resourcesCHAINAction = new QAction(QIcon(":/icons/web-chain"), tr("&Blockchain Explorer"), this);
	resourcesCHAINAction->setToolTip(tr("Visit the Official Moldovacoin Blockchain Explorer"));
	resourcesSTATSAction = new QAction(QIcon(":/icons/web-stats"), tr("&Statistics"), this);
	resourcesSTATSAction->setToolTip(tr("View the latest Moldovacoin network and market statistics!"));
    resourcesCHARTSAction = new QAction(QIcon(":/icons/web-charts"), tr("&Charts"), this);
	resourcesCHARTSAction->setToolTip(tr("View the latest Moldovacoin network charts!"));
	resourcesTWITTERAction = new QAction(QIcon(":/icons/web-twitter"), tr("&Twitter"), this);
	resourcesTWITTERAction->setToolTip(tr("Visit the Official Moldovacoin Twitter"));
	resourcesBTCTAction = new QAction(QIcon(":/icons/web-btct"), tr("&Discussion Forum"), this);
	resourcesBTCTAction->setToolTip(tr("Visit the Moldovacoin discussion forum on bitcointalk.org"));
...
void BitcoinGUI::createToolBars()
{
	...
	QToolBar *toolbar2 = addToolBar(tr("Moldovacoin top-logo"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Moldovacoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Moldovacoin client"));
...
{
     QDesktopServices::openUrl(QUrl("http://moldovacoin.net/"));
}

void BitcoinGUI::resourcesCHAINClicked()
{
     QDesktopServices::openUrl(QUrl("http://explorer.moldovacoin.tech/"));
}

void BitcoinGUI::resourcesSTATSClicked()
{
     QDesktopServices::openUrl(QUrl("http://moldovacoin.net/stats/"));
}

void BitcoinGUI::resourcesCHARTSClicked()
{
     QDesktopServices::openUrl(QUrl("http://moldovacoin.net/charts/"));
}

void BitcoinGUI::resourcesTWITTERClicked()
{
     QDesktopServices::openUrl(QUrl("https://twitter.com/moldovacrypto"));
}

void BitcoinGUI::resourcesBTCTClicked()
{
     QDesktopServices::openUrl(QUrl("https://bitcointalk.org/index.php?topic=2985646.0"));
}

void BitcoinGUI::resourcesCMCClicked()
{
     QDesktopServices::openUrl(QUrl("http://coinmarketcap.com/currencies/Moldovacoin"));
}
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    case 2: icon = ":/icons/connect_3"; break;
	case 3: icon = ":/icons/connect_4"; break;
    case 4: icon = ":/icons/connect_5"; break;
    case 5: icon = ":/icons/connect_6"; break;
	case 6: icon = ":/icons/connect_7"; break;
    default: icon = ":/icons/connect_8"; break;
    }
    labelConnectionsIcon->setPixmap(QIcon(icon).pixmap(28,54));
    labelConnectionsIcon->setToolTip(tr("Moldovacoin Network<br><br>Connections: <b>%n</b>", "", count));
}
...
void BitcoinGUI::updateStakingIcon()
{
    ...
    {
        labelStakingIcon->setToolTip(tr("You are not minting MDC: <b>Your wallet is locked</b><br>Moldovacoin Network Weight: <b>%1</b><br>MultiSend: <b>%2</b>").arg(nNetworkWeight).arg(fMultiSend ? tr("Active"):tr("Inactive")));
        labelStakingIcon->setEnabled(false);
        labelStakingIcon->setPixmap(QIcon(":/icons/staking_off").pixmap(28,54));
    }
    else if (vNodes.empty())
    {
        labelStakingIcon->setToolTip(tr("You are not minting MDC: <b>Your wallet is offline</b><br>Moldovacoin Network Weight: <b>%1</b><br>MultiSend: <b>%2</b>").arg(nNetworkWeight).arg(fMultiSend ? tr("Active"):tr("Inactive")));
        labelStakingIcon->setEnabled(false);
        labelStakingIcon->setPixmap(QIcon(":/icons/staking_off").pixmap(28,54));
    }
    else if (IsInitialBlockDownload())
    {
        labelStakingIcon->setToolTip(tr("You are not minting MDC: <b>Your wallet is syncing with the Moldovacoin network</b><br>Moldovacoin Network Weight: <b>%1</b><br>MultiSend: <b>%2</b>").arg(nNetworkWeight).arg(fMultiSend ? tr("Active"):tr("Inactive")));
        labelStakingIcon->setEnabled(false);
        labelStakingIcon->setPixmap(QIcon(":/icons/staking_off").pixmap(28,54));
    }
    else if (!nWeight)
    {
        labelStakingIcon->setToolTip(tr("You are not minting MDC: <b>You don't have mature coins</b><br>Moldovacoin Network Weight: <b>%1</b><br>MultiSend: <b>%2</b>").arg(nNetworkWeight).arg(fMultiSend ? tr("Active"):tr("Inactive")));
        labelStakingIcon->setEnabled(false);
        labelStakingIcon->setPixmap(QIcon(":/icons/staking_off").pixmap(28,54));
    }
    ...
    {	
		...
		labelStakingIcon->setToolTip(tr("You are minting MDC: <b>Happy Staking!</b><br><br>Moldovacoin Network Weight: <b>%1</b><br><br>My Wallet Weight: <b>%2</b><br><br>Estimated Next Stake: <b>%4</b><br><br>MultiSend: <b>%5</b>").arg(nNetworkWeight).arg(nWeight).arg(text).arg(fMultiSend ? tr("Active"):tr("Inactive")));
    }
    else
    {
        labelStakingIcon->setToolTip(tr("You are not minting MDC.<br>Moldovacoin Network Weight: <b>%1</b>").arg(nNetworkWeight));
        labelStakingIcon->setEnabled(false);
        labelStakingIcon->setPixmap(QIcon(":/icons/staking_off").pixmap(28,54));
    }
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Moldovacoin address or malformed URI parameters."));
    }
...
{
    if (!fUseMoldovacoinTheme)
        return;

    QString qssPath = QString::fromStdString( GetDataDir().string() ) + "/Moldovacoin.qss";
