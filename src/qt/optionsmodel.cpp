...
void OptionsModel::Init()
{
    ...
    fUseMoldovacoinTheme = settings.value("fUseMoldovacoinTheme", true).toBool();
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case UseMoldovacoinTheme:
            return QVariant(fUseMoldovacoinTheme);
        default:
            return QVariant();
        }
    }
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case CoinControlFeatures: {
            ...
            break;
        case UseMoldovacoinTheme:
            fUseMoldovacoinTheme = value.toBool();
            settings.setValue("fUseMoldovacoinTheme", fUseMoldovacoinTheme);
            break;
        default:
            break;
        }
